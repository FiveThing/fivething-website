...
const Landing = () => {
  return (
    <div className="h-screen flex relative items-center">
      ...
      <div className="mx-16 text-center text-xl">
        <ul className="hover:text-blob-f98 transition ease-in-out cursor-pointer" onClick={() => window.fullpage_api.moveSectionDown()}>
          <li>H</li><li>O</li><li>M</li><li>E</li>
        </ul>
      </div>
